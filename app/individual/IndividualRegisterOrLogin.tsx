...
export default function IndividualRegisterOrLogin() {
  const router = useRouter();
  const handleRegister = () => {
    // Kayıt sayfasına yönlendir
    router.push('/individual/IndividualRegister');
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={require('../../assets/images/logoindividual.png')} style={styles.LogoStyle} />
        ...
        <Image source={require('../../assets/images/individualRegisterOrLogin.png')} style={styles.IndividualImage} />
         <Text style={styles.IndividualText}>Bireysel</Text>
