...
export default function Profile() {
  ...
  const [stats, setStats] = useState<{
    ...
    week_in_progress: number;
    week_cancelled: number;
    month_completed: number;
    month_in_progress: number;
            ...
            <View style={styles.section}>
              ...
              <View style={styles.card}>
                <View style={styles.cardContent}>
                  ...
                  <Text style={styles.taskText}>{stats?.today_cancelled ?? 0} Görev iptal edildi</Text>
                </View>
              </View>
              ...
              <View style={styles.card}>
                <View style={styles.cardContent}>
                  ...
                  <Text style={styles.taskText}>{stats?.week_cancelled ?? 0} Görev iptal edildi</Text>
                </View>
              </View>
              ...
              <View style={styles.card}>
                <View style={styles.cardContent}>
                  ...
                  <Text style={styles.taskText}>{stats?.month_cancelled ?? 0} Görev iptal edildi</Text>
                </View>
              </View>
            </View>
          )}
