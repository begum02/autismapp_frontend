...
export default function IndividualRegister() {
  ...
  const handleRegister = () => {
       if (!email.trim() || !password || !confirmPassword) {
          Alert.alert('Başarılı', 'Kayıt işlemi başarılı (örnek).', [
          { text: 'Tamam', onPress: () => router.push('/individual/IndividualLogin') },
        ]);
        }
    ...
    >
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.form}>
          ...
          <Pressable style={styles.Register} onPress={handleRegister} accessibilityRole="button">
